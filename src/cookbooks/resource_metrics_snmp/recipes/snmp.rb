...
telegraf_snpm_template_file = 'telegraf_snmp.ctmpl'
file "#{consul_template_template_path}/#{telegraf_snpm_template_file}" do
  action :create
  content <<~CONFIG
    [[inputs.snmp]]
      agents = [
...
telegraf_snmp_file = 'inputs_snmp.conf'
file "#{consul_template_config_path}/telegraf_snmp.hcl" do
  ...
  content <<~HCL
    ...
    template {
      ...
      # the `contents` option.
      source = "#{consul_template_template_path}/#{telegraf_snpm_template_file}"

      # This is the destination path on disk where the source template will render.
      # If the parent directories do not exist, Consul Template will attempt to
      # create them, unless create_dest_dirs is false.
      destination = "#{node['telegraf']['config_directory']}/#{telegraf_snmp_file}"
